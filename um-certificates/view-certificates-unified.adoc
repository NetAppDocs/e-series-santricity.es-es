...
.Pasos
. En el panel izquierdo, selecciona menú:Settings[Certificates].
...
. Para ver más información sobre un certificado, selecciona su fila, selecciona la elipsis al final de la fila y luego haz clic en *Ver* o *Export*.
