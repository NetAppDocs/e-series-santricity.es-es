...
[role="lead"]
En la siguiente tabla, se describen las nuevas funciones de SANtricity System Manager 11,8x.
...
El nuevo tamaño de clave de certificado predeterminado es de 3072 bits (desde 2048). Se admiten tamaños de llave de hasta 4096 bits. Debe cambiarse un bit de NVSRAM para que admita los tamaños de claves no predeterminados.
 ...
 a| 
Compatibilidad con pools de discos dinámicos más grandes utilizando unidades con tamaños de bloque de 512b KB
 a| 
Los clientes que utilicen el tipo de versión de pool de la versión 1 pueden ahora tener un pool de discos de tamaño máximo de 48 TB. La versión anterior admite un tamaño de pool de discos de hasta 24 TB. Si se van a convertir los pools de discos existentes al tamaño mayor, primero deben eliminarse todos los volúmenes. La operación de degradación está restringida cuando existe un pool de discos versión 1.
