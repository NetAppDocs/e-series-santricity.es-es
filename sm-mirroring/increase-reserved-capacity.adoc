...
. Selecciona el objeto de almacenamiento para el que quieres aumentar la capacidad reservada y luego haz clic en el icono de menú:ellipsis icon[Aumentar capacidad reservada].
+
Aparece la página Increase Reserved Capacity.
