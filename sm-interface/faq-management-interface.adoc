...
El gráfico de latencia proporciona estadísticas de latencia, en milisegundos (ms), para volúmenes, grupos de volúmenes, pools, aplicaciones y cargas de trabajo. Este gráfico aparece en las pestañas vista lógica, vista física y aplicaciones y cargas de trabajo vista.
...
El gráfico IOPS muestra estadísticas de operaciones de entrada/salida por segundo. En la página de inicio, este gráfico muestra estadísticas para el array de almacenamiento. En las pestañas Logical View, Physical View y Applications and workloads View de la página Performance, este gráfico muestra estadísticas para el array de almacenamiento, volúmenes, grupos de volúmenes, pools, aplicaciones y cargas de trabajo.
...
El gráfico MiB/s muestra estadísticas de velocidad de transferencia en mebibytes por segundo. En la página Home, este gráfico muestra estadísticas para la storage array. En las pestañas Logical View, Physical View y Applications and workloads View de la página Performance, este gráfico muestra estadísticas para la storage array, los volumes, volume groups, pools, applications y workloads.
...
El gráfico CPU muestra estadísticas de capacidad de procesamiento para cada controlador (controlador A y controlador B). CPU es una abreviatura de _central processing unit_. En la página de inicio, este gráfico muestra estadísticas para la matriz de almacenamiento. En la pestaña Vista física de la página Rendimiento, este gráfico muestra estadísticas para la matriz de almacenamiento y las unidades.
...
El gráfico Headroom está relacionado con la capacidad de rendimiento restante de los controladores de la matriz de almacenamiento. Este gráfico es visible en la página de inicio y en la pestaña Physical View de la página Performance.
