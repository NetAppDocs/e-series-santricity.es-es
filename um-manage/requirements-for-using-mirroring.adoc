...
[NOTE]
====
La duplicación síncrona no está disponible en la matriz de almacenamiento EF80, EF50, EF600/EF600C o EF300/EF300C.
...
NOTE: Los controladores E4000 no admiten la duplicación iSCSI.
...
* Los volúmenes primarios y secundarios no deben tener habilitada la partición de recursos.
