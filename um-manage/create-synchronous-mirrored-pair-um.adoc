...
[NOTE]
====
Esta función no está disponible en el sistema de almacenamiento EF80, EF50, EF600/EF600C o EF300/EF300C.
...
.Después de terminar
Ve a System Manager y al menú:Storage[Operations in Progress] para ver el progreso de la operación de mirroring síncrono. Esta operación puede ser larga y podría afectar el rendimiento del sistema.
