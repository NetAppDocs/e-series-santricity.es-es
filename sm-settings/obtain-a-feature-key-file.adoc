...
---
= Obtenga un archivo de clave de función en SANtricity System Manager
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.Pasos
. En System Manager, localiza y anota el número de serie del chasis. Desde el panel izquierdo, ve al menú:Support[Suport Center] y desplázate hacia abajo hasta *View top storage array properties* para ver el número de serie del chasis.
. En System Manager, localiza el Feature Enable Identifier. Desde el panel izquierdo, ve a menu:Settings[System] y luego desplázate hacia abajo hasta *Add-ons*. Busca el *Feature Enable Identifier*. Anota el número del Feature Enable Identifier.
