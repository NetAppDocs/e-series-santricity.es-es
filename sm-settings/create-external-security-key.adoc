...
** *Seleccionar archivo de clave privada* -- Si lo necesitas, haz clic en el segundo botón *Browse* para seleccionar un archivo de clave privada para los controladores de la matriz de almacenamiento.
