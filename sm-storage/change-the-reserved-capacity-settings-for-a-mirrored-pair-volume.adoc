...
. Selecciona el volumen de par reflejado que quieres editar y luego haz clic en el icono de menú:ellipsis[Edit Settings].
+
Aparece la ventana Edit Mirrored Pair Volume Reserved Capacity Settings.
...
Umbral de alerta de capacidad reservada llena
 a| 
Usa la barra para ajustar el punto porcentual en el que System Manager envía una notificación de alerta cuando la capacidad reservada para un par reflejado está a punto de llenarse.
