...
. Selecciona el objeto de almacenamiento para el que quieres disminuir la capacidad reservada y luego haz clic en el icono menu:ellipsis[Decrease Capacity].
+
Aparece la página Decrease Reserved Capacity.
