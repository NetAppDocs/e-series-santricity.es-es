...
summary: Puedes editar la configuración de la caché SSD. La configuración actual de la caché SSD está disponible a través de la opción Ver configuración. 
---
...
[role="lead"]
Puedes editar la configuración de la caché SSD. La configuración actual de la caché SSD está disponible a través de la opción Ver configuración.

.Pasos
. En el panel izquierdo, selecciona menú:Storage[Pools y grupos de volúmenes].
. Selecciona la caché SSD que quieres editar y luego haz clic en el icono de menú:ellipsis icon[Edit Settings].
+
Aparece la ventana Edit SSD Cache Settings.
