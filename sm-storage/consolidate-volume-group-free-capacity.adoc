...
* También puedes iniciar el cuadro de diálogo Consolidar capacidad libre desde la página Pools y grupo de volúmenes como se describe en la siguiente tarea.
...
. Haz clic en el icono del menú:elipsis[Consolidate volume group free capacity].
+
...
.Después de terminar
Selecciona menú:Storage[Operations in Progress] para ver el progreso de la operación Consolidate Free Capacity. Esta operación puede ser larga y podría afectar el rendimiento del sistema.
