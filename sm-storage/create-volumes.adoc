...
+
Aparece la página Create Volumes.
...
. Si tu carga de trabajo está asociada con un tipo de aplicación compatible, ingresa la información solicitada; de lo contrario, ve a <<Paso 3: agrega volúmenes>>.




== Paso 3: agrega volúmenes
...
+
** 2,048 volúmenes (EF80, EF600, EF600C y serie E5700)
** 1,024 volúmenes (EF50, EF300 y EF300C)
...
DA mejora la integridad de los datos en todo el sistema de almacenamiento. DA permite que la cabina de almacenamiento compruebe y corrija los errores que se pueden producir durante la transferencia de datos a través de las controladoras hasta las unidades. El uso DE DA en el volumen nuevo garantiza la detección de cualquier error.
 ...
 a| 
Recurso aprovisionado (EF80, EF50, EF300 y EF600 solamente)
 a| 
*Sí* aparece junto a "Resource provisioned" solo si las unidades admiten esta opción. Resource Provisioning es una función disponible en las matrices de almacenamiento EF80, EF50, EF300 y EF600, que permite poner en uso volúmenes inmediatamente sin proceso de inicialización en segundo plano.

|===
====
** *Carga de trabajo específica de la aplicación* -- Haz clic en *Edit Volumes* para cambiar, agregar o eliminar los volúmenes y características recomendados por el sistema para la carga de trabajo seleccionada.
+
.Detalles del campo
[%collapsible]
====
...
Tipo de volumen indica el tipo de volumen que se creó para una carga de trabajo específica de la aplicación.
 ...
 a| 
Tamaño del bloque de volumen (EF80, EF50, EF300 y EF600 solamente)
 a| 
Muestra los tamaños de bloque que se pueden crear para el volumen:
...
+
El SMcli está disponible directamente a través de SANtricity System Manager. Esta versión descargable del SMcli está disponible en EF80, EF50, E4000, EF600, EF600C, EF300, EF300C, E5700, EF570, E2800 y EF280. Para descargar el SMcli dentro de SANtricity System Manager, selecciona *Settings* > *System* y *Add-ons* > *Command Line Interface*.
