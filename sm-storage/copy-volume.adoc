...
. Selecciona el volumen que quieres usar como fuente para la operación Copy Volume y luego haz clic en el icono menu:ellipsis[Copy volume].
+
Aparece la ventana Copy Volume.
...
.Después de terminar
Selecciona el menú:Storage[Operations in Progress] para ver el progreso de la operación Copy Volume. Esta operación puede ser larga y podría afectar el rendimiento del sistema.
