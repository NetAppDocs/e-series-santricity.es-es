...
Un grupo de volúmenes puede contener unidades con o sin capacidad DA, pero todas las unidades deben poseer capacidad DA para que pueda usarse esta función.
 ...
 a| 
Aprovisionamiento de recursos disponible (solo EF80, EF50, EF300 y EF600)
 a| 
Muestra si Resource Provisioning está disponible para este grupo. Resource Provisioning es una función disponible en las matrices de almacenamiento EF80, EF50, EF300 y EF600, que permite que los volúmenes se pongan en uso inmediatamente sin ningún proceso de inicialización en segundo plano.
