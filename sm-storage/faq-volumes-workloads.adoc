...
* También puedes ir a menú:Storage[Pools y grupos de volúmenes] desde el panel izquierdo y luego seleccionar el icono de menú:ellipsis[Consolidar la capacidad libre del grupo de volúmenes] para abrir el cuadro de diálogo.
