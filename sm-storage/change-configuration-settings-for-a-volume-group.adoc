...
. Selecciona el grupo de volúmenes que quieres editar y luego haz clic en el menú:ellipsis icon[Edit Settings].
+
Aparece la ventana Edit Volume Group Settings.

. Edita la configuración del grupo de volúmenes según corresponda.
+
.Detalles del campo
[%collapsible]
====
