...
+
** En el panel izquierdo, selecciona menu:Storage[Volumes]. Selecciona el objeto (volumen base o snapshot consistency group) y luego haz clic en el icono menu:ellipsis[Create instant snapshot].
** En el panel izquierdo, selecciona menu:Storage[Snapshots]. Selecciona la pestaña *Snapshot Images* y luego selecciona menu:Create[Instant snapshot Image].
+
