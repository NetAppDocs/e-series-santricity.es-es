...
+
Agregas capacidad a un volumen seleccionando menu:Storage[Volumes] desde el panel izquierdo y luego seleccionando el menú:ellipsis icon[Increase capacity] para el volumen.
...
+
Añades capacidad no asignada al pool o grupo de volúmenes seleccionando menú:Storage[Pools and Volume Groups > Add capacity].
...
Al copiar volúmenes, creas una copia de un momento específico de dos volúmenes separados, el volumen de origen y el volumen de destino, en la misma matriz de almacenamiento. Puedes copiar volúmenes seleccionando menu:Storage[Volumes] y luego seleccionando el icono menu:ellipsis[Copy volume].
...
Puedes inicializar los volúmenes seleccionando menú:Storage[Volumes > ellipsis icon > Initialize volumes].
...
Puedes redistribuir volúmenes seleccionando menu:Storage[Volumes > ellipsis icon > Redistribute volumes].



== Cambiar la propiedad de un volumen

Cambiar la propiedad de un volumen cambia la propiedad preferida del controlador del volumen. El propietario preferido del controlador de un volumen aparece en menu:Storage[Volumes > ellipsis icon > Edit settings].

Puedes cambiar la propiedad de un volumen seleccionando menu:Storage[Volumes > ellipsis icon > Change volume ownership].
...
Selecciona el menú:Storage[Volumes > ellipsis icon > Change cache settings] para cambiar la siguiente configuración de caché:
