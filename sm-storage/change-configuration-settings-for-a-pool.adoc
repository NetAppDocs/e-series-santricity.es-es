...
. Selecciona el pool que quieres editar y luego haz clic en el menú:ellipsis icon[Edit Settings].
+
Aparece la ventana Edit pool Setting.

. Edita la configuración del grupo según corresponda.
+
.Detalles del campo
[%collapsible]
====
