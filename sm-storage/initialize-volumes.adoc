...
. Haz clic en el icono del menú:ellipsis[Initialize volumes].
+
...
Selecciona menú:Storage[Operations in Progress] para ver el progreso de la operación de inicialización que se está ejecutando actualmente para el volumen seleccionado. Esta operación puede ser larga y podría afectar el rendimiento del sistema.
