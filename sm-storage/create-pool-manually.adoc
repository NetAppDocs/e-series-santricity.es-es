...
DA está activado si todas las unidades son aptas para DA. DA puede desactivarse después de que se crea el volumen seleccionando menu:Storage[Volumes > ellipsis icon > Disable Data Assurance].



 a| 
Resource Provisioning Capable (solo EF80, EF50, EF300 y EF600)
 a| 
Muestra si Resource Provisioning está disponible para este candidato a pool. Resource Provisioning es una función disponible en las matrices de almacenamiento EF80, EF50, EF300 y EF600, que permite poner en uso volúmenes inmediatamente sin proceso de inicialización en segundo plano.
