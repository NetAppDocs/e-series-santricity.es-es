...
+
Si no existe capacidad libre en el pool o grupo de volúmenes que contiene el objeto de almacenamiento que seleccionaste y el storage array tiene Unassigned Capacity, puedes Add capacity. Puedes crear un nuevo pool o grupo de volúmenes y luego volver a intentar esta operación usando la nueva capacidad libre en ese pool o grupo de volúmenes.
...
.Después de terminar
Selecciona menu:Storage[Operations in Progress] para ver el progreso de la operación de reversión.
