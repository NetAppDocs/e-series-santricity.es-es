...
* Cuando se detecta capacidad no asignada, aparece la recomendación de Pool Auto-Configuration en el área de notificaciones (icono de campana en la parte superior de la ventana). Haz clic en *View Pool Auto-Configuration* para abrir el cuadro de diálogo.
...
. Haz clic en el icono del menú:ellipsis[Launch pool auto-configuration].
+
...
. Para ver características adicionales de la agrupación, haz clic en el nombre de la agrupación que aparece.
+
