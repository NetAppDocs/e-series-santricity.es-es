...
. Haz clic en el icono de menú:ellipsis[Change volume ownership].
+
Aparece la ventana Change Volume Ownership. Todos los volúmenes en la storage array aparecen en este cuadro de diálogo.
