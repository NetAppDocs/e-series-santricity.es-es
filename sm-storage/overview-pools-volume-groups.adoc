...
Puedes permitir que System Manager cree pools automáticamente cuando detecta capacidad no asignada en una matriz de almacenamiento. O bien, cuando la creación automática no puede determinar la mejor configuración, puedes crear pools manualmente desde menu:Storage[Pools and volume groups].
...
Puedes crear grupos de volúmenes desde el menú:Storage[Pools and volume groups].
