...
. Haz clic en el icono de menú:ellipsis[Cambiar configuración de escaneo de medios de volumen].
+
Aparece la ventana Change Drive Media Scan Settings. Todos los volúmenes de la matriz de almacenamiento aparecen en este cuadro de diálogo.

. Para activar el escaneado de soportes, selecciona la casilla de comprobación *Escaneado de soportes*.
+
