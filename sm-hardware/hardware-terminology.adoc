...
DULBE
 a| 
El error de bloque lógico desasignado o no escrito (DULBE) es una opción en las unidades NVMe que permite que la matriz de almacenamiento EF80, EF50, EF300/EF300C o EF600/EF600C admita volúmenes aprovisionados de recursos.
