...
Compatible con DULBE
 a| 
Indica si la opción de Deallocated or Unwritten Logical Block Error (DULBE) está activada (Sí) o no (No). DULBE es una opción en las unidades NVMe que permite que la matriz de almacenamiento EF80, EF50, EF300 o EF600 admita volúmenes aprovisionados con recursos.
