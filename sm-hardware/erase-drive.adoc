...
====
. En el menú contextual, selecciona *Borrar unidades*.
+
...
. Confirma la operación escribiendo `erase`, y luego haz clic en *Borrar unidades*.
+
[CAUTION]
====
...
.Resultados
La operación de borrado puede tardar varios minutos o varias horas. Puedes ver el estado en menú:Almacenamiento[Operaciones en curso]. Cuando finaliza la operación de borrado, las unidades están disponibles para usarse en otro grupo de volúmenes o grupo de discos, o en otra matriz de almacenamiento.
